...
/// <summary>Causal event recording check-out from an appointment.</summary>
[GenerateSerializer, Immutable]
public sealed record AppointmentCheckedOutV1 : IClinicalEvent
{
    ...
    [Id(7)] public DateTime CheckOutDateTime { get; init; }

    public string Canonicalize() => string.Join("|",
        nameof(AppointmentCheckedOutV1),
        AppointmentId,
        CheckOutDateTime.ToString("O"));
}
