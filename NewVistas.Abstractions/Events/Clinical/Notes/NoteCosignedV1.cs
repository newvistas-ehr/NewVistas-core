...
/// <summary>
/// Causal event recording the cosignature of a TIU document — transitions
/// the document from UNCOSIGNED to COMPLETED.
/// </summary>
[GenerateSerializer, Immutable]
public sealed record NoteCosignedV1 : IClinicalEvent
{
    ...
    /// <summary>UTC instant the cosignature was recorded.</summary>
    [Id(7)] public DateTime CosignedDateTime { get; init; }

    public string Canonicalize() => string.Join("|",
        nameof(NoteCosignedV1),
        DocumentId,
        CosignedDateTime.ToString("O"));
}
