# Radiology Orders and Interpretation -- Physician Human Test Script -- WPF UI
...
2. In the Navigation Panel, select **Radiology**
3. Enter Patient ID in the toolbar: `22`
4. Click **Load** (or press Enter)
5. Note any existing radiology studies in the Studies TabItem
...
8. Fill in:
   ...
   - CPT Code: `71046`
   - Imaging Type: **GENERAL RADIOLOGY** (ComboBox; options: GENERAL RADIOLOGY, CT SCAN, MRI, ULTRASOUND, NUCLEAR MEDICINE, MAMMOGRAPHY)
...
#### Expected Result
- A green notification appears in the status bar: "Study ordered."
- The form closes
- Studies list reloads
- New study appears in the DataGrid with:
  - Date: today (Exam Date)
  - Procedure: Chest X-Ray PA and Lateral
  - Type: GENERAL RADIOLOGY
  - Requesting: PATEL,ARUN K
  - Status: status indicator "PENDING" (blue)
  - Report: "--"
...
#### Steps
1. Click the **Complete** button on the Chest X-Ray row (or right-click and select **Complete**)

#### Expected Result
- A green notification appears in the status bar: "Study completed."
- Status changes to "COMPLETE" (green status indicator)
...
#### Steps
1. Click the study row to open the **Study Detail** TabItem

#### Expected Result
- Detail panel shows:
  - Procedure name header with COMPLETE status indicator
...
#### Steps
1. Complete the study (click **Complete** button on the row, or right-click and select **Complete**)
...
5. Fill in:
   ...
   - Route: **IV** (ComboBox; options: IV, ORAL, RECTAL, INTRATHECAL)
   - Volume (mL): `100`
6. Click **Record Contrast**

#### Expected Result
- A green notification appears in the status bar: "Contrast recorded."
...
- Appears in the studies DataGrid with STAT urgency indicator
...
### Expected Result
- Each study appears with the correct Imaging Type in the studies DataGrid
...
### Expected Result
- A green notification appears in the status bar: "Radiation dose recorded."
...
### Expected Result
- A green notification appears in the status bar: "Flagged as critical."
- Detail refreshes showing:
  - Red "CRITICAL" status indicator in the header
  - Critical section shows: "YES" status indicator
...
### Expected Result
- A green notification appears in the status bar: "Notification recorded."
...
### Expected Result
- A green notification appears in the status bar: "Critical result acknowledged."
...
#### Expected Result
- A green notification appears in the status bar: "Report signed."
- Detail refreshes showing:
...
#### Expected Result
- A green notification appears in the status bar: "Report amended."
- Detail refreshes showing the Amendment text and Amendment date
- The amendment TextBox clears
...
### Expected Result
- A green notification appears in the status bar: "Contrast reaction recorded."
- Detail refreshes showing:
  - Reaction: "YES" red status indicator
...
### Expected Result
- A red error notification appears in the status bar: "Procedure name is required."
