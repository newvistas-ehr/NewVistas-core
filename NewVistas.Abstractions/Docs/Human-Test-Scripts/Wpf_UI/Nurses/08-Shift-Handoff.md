# Shift Handoff (SBAR) -- Human Test Script -- WPF UI
...
- **Pre-conditions:**
  ...
  2. In the Navigation Panel, select **Shift Handoff**.
  3. Enter Patient ID `9` in the Patient ID field in the toolbar and click **Load**.
  4. The Handoff History TabItem loads. If no handoffs exist, the DataGrid is empty.
...
1. In the Navigation Panel, select **Shift Handoff**.
2. Enter Patient ID: `9` in the Patient ID field in the toolbar.
3. Click **Load**.
4. Click the **New Handoff** TabItem.
5. Fill in all fields:
   - Shift ComboBox: `Day`
   - Outgoing Nurse ID TextBox: `NURSE1`
   - Outgoing Nurse Name TextBox: `JOHNSON,MARY R`
   - Bed # TextBox: `301-A`
   - **S -- Situation** TextBox:
     ```
...
- A green notification appears in the status bar: "Handoff created: HANDOFF-..."
- Switch to the **Handoff History** TabItem. The new entry shows:
  - Date: today's date
  - Shift: Day
  - Outgoing: JOHNSON,MARY R
  - Incoming: -- (not yet assigned)
  - Status: **Draft** (yellow/warning status indicator)
- Click **View** (or right-click and select **View**) to see the full report on the **Report Detail** TabItem.
...
1. On the **Handoff History** TabItem, click **View** on the handoff created in Scenario 1 (or right-click and select **View**).
2. The **Report Detail** TabItem displays the full handoff.
...
- **Safety Concerns** alert panel (if any safety concerns exist).
...
1. On the **Report Detail** TabItem, with the Draft handoff open, click **Complete Report**.

### Expected Result

- The detail reloads.
- Status changes from **Draft** to **Completed** (blue/primary status indicator).
- The **Complete Report** button disappears.
- A new button appears: **Acknowledge (Incoming)**.
- On the Handoff History TabItem, the Status column shows: Completed.
...
4. Click **Load**.
5. On the **Handoff History** TabItem, locate the Completed handoff from Scenario 3.
6. Click **View** (or right-click and select **View**) to open the Report Detail.
...
- The detail reloads.
- Status changes from **Completed** to **Acknowledged** (green/success status indicator).
- The **Acknowledge (Incoming)** button disappears.
- The Incoming nurse field now shows: **Incoming Nurse** (the name passed in the acknowledgment call -- in the current implementation, hardcoded as "Incoming Nurse" and "RN-INCOMING" in the WPF view).
- On the Handoff History TabItem:
  - Incoming: Incoming Nurse
  - Status: Acknowledged (green status indicator)
...
3. Enter Patient ID: `9` in the Patient ID field in the toolbar.
4. Click **Load**.
5. Click the **New Handoff** TabItem.
6. Fill in:
   - Shift ComboBox: `Evening`
   - Outgoing Nurse ID TextBox: `NURSE2`
   - Outgoing Nurse Name TextBox: `THOMPSON,PATRICIA A`
   - Bed # TextBox: `301-A`
   - **S -- Situation** TextBox:
     ```
...
1. On the **Handoff History** TabItem, observe all handoff entries for Patient 9.

### Expected Result

- The DataGrid shows all handoffs in chronological order:
