...
static async Task SeedDemoSecurityKeysAsync(IServiceProvider services)
{
    ...
    var roleKeyMap = new Dictionary<string, string[]>
    {
        ...
        ["Administrator"]     = [SecurityKeys.XUMGR, SecurityKeys.XUAUDIT, SecurityKeys.DG_SENSITIVITY, SecurityKeys.DG_BED_CONTROL, SecurityKeys.EPI_MANAGER, SecurityKeys.IB_PROC_PRECERT],
        ["RegistrationClerk"] = [SecurityKeys.SD_SCHEDULING, SecurityKeys.DG_ADMIT, SecurityKeys.DG_BED_CONTROL, SecurityKeys.IB_PROC_PRECERT],
