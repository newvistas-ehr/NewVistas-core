...
{
    private const string MainSchemaResource = "NewVistas.WebServer.Sql.OrleansMainSchema.sql";
    private const string ClusteringSchemaResource = "NewVistas.WebServer.Sql.OrleansClusteringSchema.sql";
    private const string PersistenceSchemaResource = "NewVistas.WebServer.Sql.OrleansPersistenceSchema.sql";
