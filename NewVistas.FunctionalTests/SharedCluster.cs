...
public static class SharedCluster
{
    ...
    public static TestCluster Instance
    {
        get
        {
            ...
            lock (_lock)
            {
                ...
                // Publish the singleton only once fully deployed — assigning _cluster
                // before Deploy() completes lets the lock-free fast path hand another
                // fixture a non-deployed cluster under ParallelScope.Fixtures.
    ...
    internal class AllStoresConfigurator : ISiloConfigurator
    {
        public void Configure(ISiloBuilder siloBuilder)
        {
            ...
            siloBuilder.AddMemoryGrainStorage("genomicsStore");
            siloBuilder.AddMemoryGrainStorage("familyHistoryStore");
            siloBuilder.AddMemoryGrainStorage("personStore");
            siloBuilder.AddMemoryGrainStorage("personIndexStore");
            ...
            siloBuilder.AddMemoryGrainStorage("homeHealthAgencyDirectoryStore");
